...
description: Evidence-based senior architect reviewer for Python codebases.
skills:
...
- **Stack Context:** Determine the actual stack from the repository (`pyproject.toml`, `requirements.txt`, entry points) rather than assuming one.
